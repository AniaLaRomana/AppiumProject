...
def customLogger():
    ...
    # 4.) Create the fileHandler to save the customLogger in the file
    fileHandler = logging.FileHandler("../logs/RegistrationHeadspace.log", mode='a')

    # 5.) Set the logLevel for fileHandler
    fileHandler.setLevel(logging.DEBUG)

    # 6.) Create the formatter in which format do you like to save the customLogger
